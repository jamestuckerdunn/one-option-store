...
export function ImagePlaceholderIcon({ className = 'w-20 h-20' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
export function CheckCircleIcon({ className = 'w-3 h-3' }: IconProps) {
  return (
...
export function StarIcon({ className = 'w-5 h-5', filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg className={`${className} ${filled ? 'fill-white' : ''}`} viewBox="0 0 20 20" aria-hidden="true">
